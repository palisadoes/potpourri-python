...
def _subject(data):
    ...
    """
    # Initialize key variables
    template = 'Views: Create tests for FILE'
...
- [The current code coverage for the file can be found here](https://codecov.io/gh/PalisadoesFoundation/talawa/tree/develop/SOURCE_DIR). If the file isn't found in this directory, or there is a 404 error, then tests have not been created.
